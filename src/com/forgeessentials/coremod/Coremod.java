...
public class Coremod implements IFMLLoadingPlugin, IFMLCallHook
{
    ...
    public Void call() throws Exception
    {
        try
        {
            ...
            root = JSON_PARSER.parse(reader);
            
            Main.setup();
            
            if (Main.autoUpdate || Main.firstRun)
            {
                getModules();
                parceManifestModules();
                getDependencies();
                classloadAll();
                
                Main.properties.setProperty("properties", "false");
    ...
    public void parceManifestModules() throws Exception
    {
        for (File file : Main.modulesFolder.listFiles())
        {
    ...
    public void classloadAll() throws Exception
    {
        /*
         * Classload libs
         */
